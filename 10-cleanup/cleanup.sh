...
echo ""
echo "If OpenShift console login was broken by a previous tutorial run that"
echo "used the 'keycloak' namespace, restore the cluster SSO Keycloak or"
echo "log in with kubeadmin."
